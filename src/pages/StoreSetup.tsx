...
import { Search, Store, UserCog, Save, Edit } from "lucide-react";
...
export default function StoreSetup() {
  ...
  const { stores, createStore, updateStore, isLoading: storesLoading } = useStores({
    page: 1,
    limit: 100,
  });
    ...
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      <div className="flex justify-between items-start gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Assign an Admin user as manager and create stores end-to-end
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Listing Admin users from the API; choose one as the store manager, then save the store.
          </CardDescription>
        </CardHeader>
        <CardContent>
